    ...
    override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        if (character != null)
        {
            ...
            if (character.HasActiveHitboxes())
            {
                ...
                Debug.LogError($"[Hitbox Mismatch] State '{stateInfo.shortNameHash}' entered, but hitboxes [{activeIndices}] were still active. This indicates a missing 'DisableAttackHitboxByIndex' event in the previous state.");
            }
